...
# Form implementation generated from reading ui file '/home/dimmen/repos/UiS_Subsea_MATE/gui/mainwindow.ui'
#
...
"")
        ...
        self.ButtonQR = QtWidgets.QPushButton(self.motorOuterContainer)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ButtonQR.sizePolicy().hasHeightForWidth())
        self.ButtonQR.setSizePolicy(sizePolicy)
        self.ButtonQR.setObjectName("ButtonQR")
        self.verticalLayout_15.addWidget(self.ButtonQR)
